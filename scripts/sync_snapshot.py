...
index=root/'dist/index.html';index.write_text(index.read_text().replace('ETF Momentum Radar','美股 ETF 动量雷达').replace('HERMES / MARKET RESEARCH','HERMES / US MARKET RESEARCH'))
